"""
Stanford Bunny mesh with SSAO (Screen Space Ambient Occlusion)
==============================================================

This example loads the Stanford Bunny mesh via Open3D, converts it to pygfx,
renders with a basic material, and applies SSAO as a post-process.
"""
...
renderer.effect_passes = [
    SSAOPass(radius=4.0, bias=0.015, intensity=10.0, power=3.0, normalize_depth=True, num_samples=32, falloff=0.15),
